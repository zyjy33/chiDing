...
//    private IWXAPI api;
    ...
    private void con(final int index, int type) {
        try {
            ...
            String user_id = mSp.getString(SpConstants.USER_ID, "");
            String ptye = mSp.getString(SpConstants.LOGIN_FLAG, "");
            if (ptye.equals(SpConstants.WEI_XIN) || ptye.equals(SpConstants.QQ_LOGIN)) {
